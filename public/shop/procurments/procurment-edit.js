...
var KTInitProcurement = function() {
    ...
    function ProductAuPanier(donnees){
        ...
        $('#tabpanier-id').append(
            ...
            '<td class="w-500px"><span id="productName_'+donnees.id+'">'+donnees.nom_produit+'</span></td>'+
            '<td class="w-300px">'+
            ...
            '</td>'+
            '<td class="w-300px">'+
                    '<input type="text" id="cout_product-'+p+'" readonly name="cout_product[]" class="form-control  rounded-0 h-30px p-1  cout_product" value=""/>'+
            '</td>'+
            ...
            '<td class="fw-bold flex-right">'+
                '<a href="javascript:;" id="'+p+'" onclick="deleteSub(this, 0, '+donnees.id+');" class="btn btn-icon btn-danger panier_btn_remove rounded-circle pulse h-30px w-30px">'+
...
$('#btn-edit').on('click', function(event){
    ...
    submitButton = document.querySelector('#btn-edit');
