...
var KTDatatablesAjaxServer = function() {
    ...
    var initDatatable = function () {
        const documentTitle = 'Opérations'
    ...
    var exportButtons = () => {
        const documentTitle = 'Liste des recettes';
                        ...
                        .then(function (response) {
                            ...
                            Swal.fire({
                                ...
                                if (result.isConfirmed) {
                                    var oTable = $('#ajax-datatable-operation').dataTable();
                                    oTable.fnDraw(false);
                                }
                            });
                        })
    ...
    return {
        init: function() {
            table = document.querySelector('#ajax-datatable-operation');
...
function addFunction() {
    ...
    $('#modal-title').html('NOUVELLE OPERATION');
...
function editFunction(id){
    $.ajax({
        ...
        success: function(resp){
            $('#modal-operation').modal('show');
            $('#modal-title').html('MODIFIER OPERATION');
