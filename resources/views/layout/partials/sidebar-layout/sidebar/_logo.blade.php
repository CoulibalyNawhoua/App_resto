...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	<!--begin::Logo image-->
	<a href="/">
		<img alt="Logo" src="{{ asset('shop/media/logos/distriforce.png') }}" class="h-50px app-sidebar-logo-default" />
		<img alt="Logo" src="{{ asset('shop/media/logos/distriforce.png') }}" class="h-20px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
