<td class="text-end">
    ...
    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true" style="">
        ...
        <div class="menu-item px-3">
            <a href="{{ route('unites.edit', $id) }}"  class="menu-link px-3">Modifier</a>
        </div>
        ...
        <div class="menu-item px-3">
            <a href="javascript:;" onclick="deleteFunction({{ $id }},'unite-delete','ajax-datatable-unite')" class="menu-link px-3" >Supprimer</a>
        </div>
    </div>
</td>
