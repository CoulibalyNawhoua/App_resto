    ...
    <div class="card card-bordered mt-10">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ route('recette-create')}}"  class="btn btn-primary me-5 btn-sm hover-elevate-up">Nouvelle recette</a>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="ajax-datatable-recette" class="table align-middle table-row-dashed fs-6 gy-5 border rounded ">
                    <thead>
