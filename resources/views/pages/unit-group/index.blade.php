<x-default-layout>
    <div class="card card-bordered mt-10">
        <div class="card-header">
            <h3 class="card-title">Groupes d'unités</h3>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="ajax-datatable-unit-group" class="table align-middle table-row-dashed fs-6 gy-5 border rounded ">
                    <thead>
    ...
    <form id="form" method="POST" action="{{ route('unit-group-store') }}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="unit_group_id" id="unit_group_id">
        <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" id="modal-unit-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="mb-5 fv-row">
                            ...
                            <input type="text" name="name" id="name_id"  class="form-control mb-2">
                        </div>
                    </div>
