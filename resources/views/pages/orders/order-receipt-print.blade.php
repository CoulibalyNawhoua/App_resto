    ...
    <div id="invoice">
        <div id="invoice-top">
            ...
            <div class="title">
                ...
                <p>Date création: <span id="invoice_date">{{ Date::parse($reception->add_date)->locale('fr')->format('l j F Y H:m:s') }}</span><br>
                </p>
            </div>
        </div>
        <div id="invoice-mid">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td><span>Dépôt déstocké</span>
                                <label >
                                    {{ $reception->order->destination->name }}
                                </label>
                            </td>
                        </tr>
                        <tr>
                            <td><span>Date réception</span>
                                <label >
                                    @if($reception->reception_date)
                                        {{ Date::parse($reception->reception_date )->locale('fr')->format('l j F Y')}}
                                    @endif
                                </label>
                            </td>
                        </tr>
