            ...
            <div class="card-body pt-10">
                ...
                <div class="row">
                    <div class="mb-3 col-md-3">
                        ...
                        <select class="form-select" data-control="select2"  data-placeholder="Aucune sélection" name="destination_id">
                    ...
                    <div class="fv-row mb-3 col-md-2">
                        ...
                        <input class="form-control rounded-0" readonly name="order_date" placeholder="Date commande" id="date_commande_id"/>
                    </div>
