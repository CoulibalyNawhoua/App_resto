    ...
    <div class="card shadow-sm mt-10">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ route('users.create') }}" class="btn btn-primary btn-sm me-5 hover-elevate-up">Nouveau utilisateur</a>
        ...
        <div class="card-body">
            <table id="ajax-datatable-users" class="table table-rounded table-striped border gy-7 gs-7">
                <thead>
