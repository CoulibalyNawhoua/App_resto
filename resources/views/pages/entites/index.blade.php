<x-default-layout>
    <div class="card card-bordered mt-10">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                ...
                <a href="{{ route('entites.create') }}" class="btn btn-primary me-5 btn-sm hover-elevate-up">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="ajax-datatable-entite" class="table align-middle table-row-dashed fs-6 gy-5 border rounded ">
                    <thead>
    ...
    <form id="form" method="POST" action="{{ route('entites.store') }}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="entite_id" id="entite_id">
        <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" id="modal-entite">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-5 fv-row">
                            <input class="form-check-input" type="checkbox" name="use_depot_principal" id="use_depot_principal_id" checked="">
                        ...
                        {{--  <div class="mb-5 fv-row">
                            ...
                            <select class="form-select" name="departements_id" id="departements_id" data-control="select2" data-placeholder="Aucun(e)">
                                <option></option>
