<x-default-layout>
    <div class="card card-bordered mt-10">
        <div class="card-header">
            <h3 class="card-title">Stock produit <span class="me-5"></span><span id="depot_stockage" class="mr-2 badge badge-square p-2 badge-primary"> @if(Auth::user()->entite())  {{ Auth::user()->entite->name }} @endif</span></h3>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="ajax-datatable-product-stock" class="table align-middle table-row-dashed fs-6 gy-5 border rounded ">
                    <thead>
                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                        <th>#</th>
                        {{--<th>Dépôt stockage</th>--}}
                        {{--  <th>Famille produit</th>
                        <th>Sous famille produit</th>  --}}
