<x-default-layout>
    <div class="card card-bordered mt-10">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                {{--  <a href="javascript:;" onclick="addFunction()" class="btn btn-primary btn-sm hover-elevate-up">Nouveau produit</a>  --}}

                <a href="{{ route('produits.create') }}" class="btn btn-primary btn-sm me-5 hover-elevate-up">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table id="ajax-datatable-produit" class="table align-middle table-row-dashed fs-6 gy-5 border rounded ">
                    <thead>
    ...
    {{--  <form id="form" method="POST" action="{{ route('produits.store') }}" enctype="multipart/form-data">
        @csrf
        <input type="hidden" name="produit_id" id="produit_id">
        <div class="modal fade" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" id="modal-produit">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-5 fv-row">
                            ...
                            <input type="text" name="nom_produit" id="nom_produit_id"  class="form-control mb-2">
                        </div>
                        <div class="mb-5 fv-row">
                        ...
                        <div class="mb-5 fv-row">
                            ...
                            <select class="form-select" name="categorie_id" id="categorie_id" data-control="select2" data-placeholder="Aucun(e)">
                                <option></option>
                        ...
                        <div class="mb-5 fv-row">
                            ...
                            <input type="text" name="prix_achat" id="prix_achat_id"  class="form-control mb-2">
                        </div>
                    </div>
