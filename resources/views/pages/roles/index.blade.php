    ...
    <div class="card shadow-sm mt-10">
        <div class="card-header">
            ...
            <div class="card-toolbar">
                <a href="{{ route('roles.create') }}"  class="btn btn-primary me-5 btn-sm hover-elevate-up">Nouveau role</a>
        ...
        <div class="card-body">
            <table id="ajax-datatable-role" class="table table-rounded table-striped border gy-7 gs-7">
                <thead>
