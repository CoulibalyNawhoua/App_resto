<x-default-layout>
    ...
    <form id="addForm" action="{{ route('squandering.store') }}" data-redirect="{{ route('squandering.index') }}" method="post">
        @csrf
        <div class="card shadow-sm mt-10">
            <div class="card-header">
                <h3 class="card-title">Nouveau gaspillage</h3>
                    ...
                    <table  id="tabpanier-id" class="table table-row-dashed table-row-gray-300 gy-3 table-rounded table-striped border gy-3 gs-3">
                        <thead class="bg-secondary text-align-center">
                            <tr class="fw-bold fs-6 text-gray-800 " >
                                ...
                                <th class="w-600px">Opération</th>
                                <th class="w-300px">Quantité</th>
                                <th class="fw-bold flex-right">Actions</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr id="tr-1">
        ...
        <div class="d-flex justify-content-end mt-10">
            <button type="button" id="btn-save-gaspillage" class="btn btn-primary">
