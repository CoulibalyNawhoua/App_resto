<x-default-layout>
    <div class="card shadow-sm mt-10">
        <div class="card-header">
            <h3 class="card-title">Liste des gaspillages <span class="me-5"></span><span id="depot_stockage" class="mr-2 badge badge-square p-2 badge-primary"> @if(Auth::user()->entite())  {{ Auth::user()->entite->name }} @endif</span></h3>
        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table id="ajax-datatable-squandering" class="table table-rounded table-striped border gy-7 gs-7">
                    <thead>
